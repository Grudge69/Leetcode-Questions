...
class Solution {
    ...
    //we have made a map where if originally a block is 0 and 
    //then it changes to 1 it means we'll mark it 2 and this 2 can be used to referred to it's original(when comparing for other blocks) 
    //as well as new state(when making changes in the array after processing) and same for other values
