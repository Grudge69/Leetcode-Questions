...
// Solution: Using BFS with Priority Queue(Dijkstra's Variation)

// With LAMBDA function for sorting priority queue
class Solution {
    class Pair{
        int i;
        int j;
...
// With COMPARABLE interface for sorting priority queue
